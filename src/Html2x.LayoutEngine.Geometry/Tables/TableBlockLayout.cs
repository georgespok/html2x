    ...
    IDiagnosticsSink? diagnosticsSink)
{
    ...
    private static IReadOnlyList<TableRowDiagnosticFacts> BuildTableRowDiagnostics(TableLayoutResult result)
    {
        return result.Rows
    ...
    private static IReadOnlyList<TableCellDiagnosticFacts> BuildTableCellDiagnostics(TableLayoutResult result)
    {
        return result.Rows
