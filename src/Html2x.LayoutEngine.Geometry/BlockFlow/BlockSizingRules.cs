...
internal sealed class BlockSizingRules
{
    ...
    public BlockMeasurementBasis ResolveBlockMeasurementBasis(BlockBox box, float availableWidth)
    {
    ...
    public BlockMeasurementBasis ResolveAtomicMeasurementBasis(BlockBox box, float availableWidth)
    {
        ArgumentNullException.ThrowIfNull(box);
