...
internal sealed class BlockContentExtentMeasurement
{
    ...
    public BlockContentExtentMeasurementResult Measure(BlockContentExtentMeasurementRequest request)
    {
        ...
        float? baseline = request.ContextKind == FormattingContextKind.InlineBlock ? 0f : null;
    ...
    private float ResolveTotalHeight(BlockContentExtentMeasurementRequest request)
    {
