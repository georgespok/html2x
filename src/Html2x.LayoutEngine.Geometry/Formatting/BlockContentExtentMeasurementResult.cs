...
internal sealed record BlockContentExtentMeasurementResult
{
    public BlockContentExtentMeasurementResult(
    ...
    public static BlockContentExtentMeasurementResult Empty { get; } = new([], 0f, 0f);
