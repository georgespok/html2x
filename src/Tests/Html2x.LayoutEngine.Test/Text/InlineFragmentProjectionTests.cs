...
public class InlineFragmentProjectionTests
{
    [Fact]
    public void InlineSiblingsWithSameBaseline_AreMergedIntoSingleLine()
    {
        ...
        var fragments = new FragmentBuilder().Build(boxTree, context.FontSource);
    ...
    public void InlineFlowSeparatedByBlockChild_EmitsSegmentsAroundBlockFragment()
    {
        ...
        childBlock.Children.Add(new InlineBox(BoxRole.Inline)
        {
            Parent = childBlock,
            TextContent = "inside",
    ...
    public void ListItemFallback_ForOrderedList_UsesSiblingOrdinalMarker()
    {
        ...
        var orderedList = new BlockBox(BoxRole.Block)
        {
            X = 0,
            Y = 0,
            Width = 500,
    ...
    private static FragmentTestContext CreateContext(ITextMeasurer textMeasurer)
    {
        ...
        return new FragmentTestContext(textMeasurer, fontSource.Object);
    }
    ...
    private static BlockBox CreateListItem(string text, BoxNode parent)
    {
