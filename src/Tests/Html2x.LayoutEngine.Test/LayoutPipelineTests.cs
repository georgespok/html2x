...
public class LayoutPipelineTests
{
    ...
    [Fact]
    public async Task BuildAsync_DiagnosticsSinkIsProvided_PublishesGeometrySnapshotAfterPaginationSucceeds()
    {
        const string html = @"
            <html>
              <body style='margin: 0;'>
        ...
        snapshotIndex.ShouldBeGreaterThan(paginationSucceededIndex);
    }
    ...
    private static LayoutPipeline CreateBuilder(
