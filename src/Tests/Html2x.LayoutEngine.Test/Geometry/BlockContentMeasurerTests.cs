...
public sealed class BlockContentMeasurerTests
{
    ...
    public void Measure_Image_ReturnsFactsWithoutMutatingInputs()
    {
        ...
        var measurement = CreateMeasurer(new FixedImageMetadataResolver(new SizePx(40d, 20d)))
    ...
    private BlockContentMeasurer CreateMeasurer(IImageMetadataResolver? imageMetadataResolver = null)
    {
        var imageResolver = CreateImageResolver(imageMetadataResolver);
        return new BlockContentMeasurer(
