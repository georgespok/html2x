...
public sealed class UsedGeometryCalculatorTests
{
    [Fact]
    public void FromBorderBox_InvalidLayoutInputs_ThrowsBeforePublishingGeometry()
    {
        Should.Throw<ArgumentOutOfRangeException>(() => UsedGeometryCalculator.FromBorderBox(
            float.NaN,
            0f,
            10f,
            10f,
    ...
    public void WithBorderSize_ResizesThroughFactoryAndPreservesInsets()
    {
        ...
        var resized = UsedGeometryCalculator.WithBorderSize(geometry, 30f, 12f);
    ...
    public void ResolveContentFlowWidth_BoxInsetsAndMarker_ReturnsAvailableWidth()
    {
        ...
        var contentWidth = UsedGeometryCalculator.ResolveContentFlowWidth(
            borderWidth: 120f,
            padding,
            border,
            markerOffset: 7f);
    ...
    {
        Should.Throw<ArgumentOutOfRangeException>(() => UsedGeometryCalculator.ResolveContentFlowWidth(
            -10f,
            new Spacing(),
            new Spacing(),
            markerOffset: 4f));
