...
internal sealed class TestFileSystemReader : IFileSystemReader
{
    ...
    public TestFileSystemReader AddFile(string path, bool exists = true)
    {
        _files[path] = exists;
        return this;
    }

    public TestFileSystemReader AddDirectory(string path, bool exists = true)
    {
        _directories[path] = exists;
        return this;
    }

    public TestFileSystemReader AddEnumeration(
        string directory,
