...
public class BorderShapeDrawerTests
{
    ...
    public void Draw_DashedBorder_RendersGaps()
    {
        ...
        {
            Top = new(width, red, BorderLineStyle.Dashed)
        };
    ...
    public void Draw_TinyBoxAndLargeBorders_DoesNotThrow()
    {
        ...
        var borders = BorderEdges.Uniform(new(8, ColorRgba.Black, BorderLineStyle.Solid));
    ...
    public static IEnumerable<object[]> CalculateRectCases()
    {
        ...
        [
            new SKSize(100, 100),
            BorderEdges.Uniform(new(10, ColorRgba.Black, BorderLineStyle.Solid)),
        ...
        [
            ...
            new BorderEdges
            {
                Top = new(10, ColorRgba.Black, BorderLineStyle.Solid),
                Right = null,
                Bottom = new(0, ColorRgba.Black, BorderLineStyle.Solid),
                Left = null
            },
            new SKRect(0, 0, 100, 10),
        ...
        [
            ...
            new BorderEdges
            {
                Top = new(8, ColorRgba.Black, BorderLineStyle.Solid),
                Right = new(4, ColorRgba.Black, BorderLineStyle.Solid),
                Bottom = new(8, ColorRgba.Black, BorderLineStyle.Solid),
                Left = new(4, ColorRgba.Black, BorderLineStyle.Solid)
            },
            new SKRect(0, 0, 30, 8),
        ...
        [
            ...
            new BorderEdges
            {
                Top = new(4, ColorRgba.Black, BorderLineStyle.Solid),
                Right = new(20, ColorRgba.Black, BorderLineStyle.Solid),
                Bottom = new(4, ColorRgba.Black, BorderLineStyle.Solid),
                Left = new(20, ColorRgba.Black, BorderLineStyle.Solid)
            },
            new SKRect(0, 0, 10, 4),
