...
public sealed class BlockBoxLayoutPublishedEquivalenceTests
{
    ...
    public void LayoutImageBlock_AppliesImageState()
    {
        ...
        image.UsedGeometry.ShouldNotBeNull().BorderBoxRect.Size.ShouldBe(new(30f, 12f));
    }
    ...
    [Fact]
    public void ResolvePublished_WithInlineText_PublishesInlineSegments()
    {
        var published = ResolvePublished(CreateInlineTextRoot(), DefaultPage())
            .Blocks
    ...
    [Fact]
    public void ResolvePublished_WithInlineText_PublishesInlineSourceIdentity()
    {
        var root = CreateRoot();
    ...
    [Fact]
    public void ResolvePublished_WithInlineBlock_PublishesInlineObjectContent()
    {
        var published = ResolvePublished(CreateInlineBlockRoot(), DefaultPage())
            .Blocks
            .ShouldHaveSingleItem();
    ...
    [Fact]
    public void ResolvePublished_WithInlineBlock_PreservesInlineFlowOrder()
    {
        var published = ResolvePublished(CreateInlineBlockRoot(), DefaultPage())
            .Blocks
            .ShouldHaveSingleItem();
    ...
    public void ResolvePublished_WithCompletedBehavior_ProducesRendererVisibleFragments(
        string caseName,
    ...
    private static IReadOnlyList<PublishedInlineItem> GetSingleInlineItems(PublishedBlock block) =>
        GetSingleInlineLine(block).Items;
        ...
        Fragment expected)
    {
        ...
        switch (actual, expected)
        {
            ...
            case (TableCellFragment actualCell, TableCellFragment expectedCell):
                ...
                actualCell.ColumnSpan.ShouldBe(expectedCell.ColumnSpan);
